...
---
## Background
> Since I started researching and writing this post, credible sources have reported that *survivors* of the first strike were [intentionally targeted, on Hegseth's orders](https://contrarian.substack.com/p/war-crimeor-murder). This was apparently covered up by claiming the second strike on the already-destroyed boat was to clear it as a navigation hazard (WTF?!). While multiple observers already labeled these strikes illegal, this seems to clinch that conclusion.
